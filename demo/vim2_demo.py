...
def drawCaption(img, caption):
    ...
    # get a font
    fnt = ImageFont.truetype('/share/jproject/fg508/naha/StackGAN/FreeMono.ttf', 50)
...
def save_super_images(sample_batchs, hr_sample_batchs,
    ...
    for j in range(batch_size):
        if not re.search('[a-zA-Z]+', captions_batch[j]):
            print('not found any letter in caption')
            #continue
...
if __name__ == "__main__":
    ...
    #embeddings = pickle.load('/share/jproject/fg508/naha/StackGAN/Data/vim2/test/mri_embeddings.pickle')
    with (open("/share/jproject/fg508/naha/StackGAN/Data/vim2/test/mri_embeddings.pickle", "rb")) as openfile:
        while True:
            try:
    ...
    for i in range(num_embeddings):
        captions_list.append(str(i))
    
    # path to save generated samples
    save_dir = '/share/jproject/fg508/naha/StackGAN/examples/vim2/'
    if num_embeddings > 0:
